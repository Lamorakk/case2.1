...
API_TOKEN = "7382448078:AAEPX2Jwht_7lU3MlqHIYfpvnLXnmMsnWj4"
ADMIN_CHAT_ID = '-1002169296979'
...
async def send_welcome(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        "Я Єва, бот-помічник модельної агенції «Luxury studio». Я допоможу тобі оформити анкету на професію «Модель для спілкування у чаті».\n\n"
        "Професія, де абсолютно кожна дівчина зможе здійснити свою мрію і вийти на дохід від 1500$+ навіть без досвіду. Все залежить від твого бажання працювати :)\n\n"
        "Давай познайомимось ближче. Дай відповідь на 5 питань (це займе 2 хвилини твого часу), і ми продовжимо спілкування далі. Ти згодна?\n",
